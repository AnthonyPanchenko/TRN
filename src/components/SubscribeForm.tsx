...
//   e.preventDefault();
//   // Handle form submission, e.g., send the email to your backend or a third-party service
//   console.log('Subscribed with:', email);
// };

// <Container css={{ maxWidth: '400px', margin: '0 auto', padding: '2rem' }}>
//   <Text h3>Subscribe to our newsletter</Text>
//   <Text>
